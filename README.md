...
The basic change of this fork in comparison to the original is the de-jQuery-fication. I removed several dependencies and added some neat features, please see [Change Log](#Change-Log).
